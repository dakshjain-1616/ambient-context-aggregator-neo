...
def cmd_timeline(args) -> None:
    ...
    from .database import init_db
    from .timeline import build_hourly_timeline, detect_focus_sessions, format_timeline_text
...
def cmd_diff(args) -> None:
    ...
    from .database import init_db
    from .context_diff import get_diff_report
...
def cmd_stats(args) -> None:
    ...
    from .database import init_db, get_db_stats, get_signal_stats
...
def cmd_focus(args) -> None:
    ...
    from .timeline import compute_confidence_score, build_hourly_timeline
