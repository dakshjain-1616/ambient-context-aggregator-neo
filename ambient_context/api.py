...
async def get_timeline(hours: int = Query(8, ge=1, le=24)):
    ...
    try:
        import math
        from ambient_context.database import get_recent_file_events, get_recent_terminal_commands
...
async def get_focus():
    ...
    try:
        ...
        from ambient_context.timeline import compute_confidence_score
...
async def list_models():
    ...
    from ambient_context.compressor import CLAUDE_MODELS, OPENROUTER_MODELS, _DEFAULT_CLAUDE_MODEL, _DEFAULT_OPENROUTER_MODEL
    return {
